...
This will stage all of your working changes and make them ready for committing. The "." in this situation means all of your working changes in the current directory (which is defaulted to your project directory).
