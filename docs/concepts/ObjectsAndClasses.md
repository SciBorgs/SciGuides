...
**Hello young aspiring programmer!** This guide will serve as a conceptual introduction to **the Java programming language** through the lens of **Objects** and **Classes**.
...
<div style="position: relative; width: 100%; padding-bottom: 56.25%; height: 0;">
  <iframe 
    src="https://www.youtube.com/embed/QXjU9qTsYCc?si=sHDeH0Lae_MktSBs"
    title="Compilation"
    frameborder="0"
...
*Here is a much more in-depth video on code compilation*
...
Memory (Primary Storage) is **different** from your **Secondary Storage** (what you would call your *main storage* or *drive*) because it is **much** smaller and **much** faster. Our programs interact with memory **much more** than they interact with secondary storage (**because we don't store a lot of data when coding a robot**). Whenever we refer to **storing things** or **stored data** we are referring to storing **in memory**.
...
>For example, we can have an **Elevator** object that **stores configuration data about the elevator** alongside **actions that can be done with the elevator**
...
**Fields** are reserved chunks of memory where you can store data. All you need to do is **define the class** that you will be using to reserve that *chunk of memory* for your field; and then **create a name** that you can use in your code to **reference** that *chunk of memory* (or object).
...
**Methods** are sets of instructions that are grouped together under **a single name**. Methods are special in that you can run them **with parameters** (data that you give the method as you run it) and **get an output** (data that the method spits out).
...
4. You can use the **return** keyword to end the method and **output** data.
