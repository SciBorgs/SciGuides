...
If you want to further indulge yourself into the art of control, there is an [amazing textbook](https://file.tavsys.net/control/controls-engineering-in-frc.pdf) specifically for control theory and its applications for FRC.
